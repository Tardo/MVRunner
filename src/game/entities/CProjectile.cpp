...
const CB2BodyInfo CProjectile::ms_BodyInfo = CB2BodyInfo(0.2f, 0.7f, 0.1f, b2_dynamicBody, CAT_PROJECTILE, false, CAT_CHARACTER_PLAYER|CAT_FIRE|CAT_BUILD|CAT_BOX|CAT_GENERIC);
